...
export const MOCK_EXPERIENCE: Experience[] = [
  ...
  },
  {
    id: 'feat-3',
    language: 'en',
    company: 'Multi-language Support',
    role: 'Global Citizen',
    start_date: '2023-06-01',
    end_date: null,
    description: 'Automatically generate authentic resumes in Chinese, English, and Japanese. No more translation headaches—perfect for international school applications or exchange programs.',
    current: true,
  },
  {
    id: 'feat-3-zh',
    ...
    start_date: '2023-06-01',
    end_date: null,
    description: '一键生成地道的中文、英文、日文简历。不再需要为翻译发愁，轻松应对国际学校申请、海外夏令营或交换项目，展现你的全球竞争力。',
    current: true,
  },
  {
    id: 'feat-3-zh-tw',
    ...
    start_date: '2023-06-01',
    end_date: null,
    description: '一鍵生成地道的中文、英文、日文簡歷。不再需要為翻譯發愁，輕鬆應對國際學校申請、海外夏令營或交換計畫，展現你的全球競爭力。',
    current: true,
  },
  {
    id: 'feat-4',
