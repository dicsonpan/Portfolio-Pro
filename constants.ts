...
export const MOCK_PROFILE_EN: Profile = {
  ...
  avatar_url: 'https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=2535&auto=format&fit=crop',
...
export const MOCK_PROFILE_ZH: Profile = {
  ...
  bio: '嗨！我是 NextFolio。我不是一个普通的网站，我是专为中小学生打造的“数字星光大道”。在升学竞争激烈、但也充满多元可能的时代，我帮助你将散落在手机里的活动照片、压在箱底的奖状证书，变成一份份精美的数字履历。无需任何编程基础，只要填写内容，我就UB能帮你把“努力的过程”变成“看得到的成就”。无论是升学面试、社团申请，还是向亲友展示，我都能让你脱颖而出！',
  avatar_url: 'https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=2535&auto=format&fit=crop',
  email: 'hello@nextfolio.dev',
  location: '云端 / 全球',
  phone: '',
